...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { detail: @notice.detail, expire_at: @notice.expire_at, property_id: @notice.property_id, publish_at: @notice.publish_at, subject: @notice.subject, user_id: @notice.user_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { detail: @notice.detail, expire_at: @notice.expire_at, property_id: @notice.property_id, publish_at: @notice.publish_at, subject: @notice.subject, user_id: @notice.user_id } }
