...
class ServiceRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_request" do
    assert_difference('ServiceRequest.count') do
      post service_requests_url, params: { service_request: { detail: @service_request.detail, property_id: @service_request.property_id, subject: @service_request.subject, user_id: @service_request.user_id } }
    end
  ...
  test "should update service_request" do
    patch service_request_url(@service_request), params: { service_request: { detail: @service_request.detail, property_id: @service_request.property_id, subject: @service_request.subject, user_id: @service_request.user_id } }
